 ...
 */
class Rate extends \AppBundle\Entity\Rate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'value', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'review', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'pack', '' . "\0" . 'AppBundle\\Entity\\Rate' . "\0" . 'user');
        }
