...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'packs', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'media');
        }
    ...
    public function addPack(\AppBundle\Entity\Pack $pack)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPack', array($pack));

        return parent::addPack($pack);
    }
    ...
    public function removePack(\AppBundle\Entity\Pack $pack)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePack', array($pack));

        return parent::removePack($pack);
    }
