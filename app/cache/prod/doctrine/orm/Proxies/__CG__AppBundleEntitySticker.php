 ...
 */
class Sticker extends \AppBundle\Entity\Sticker implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'emojis', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'size', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'media', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Sticker' . "\0" . 'pack');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sticker $proxy) {
    ...
    public function getEmojis()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmojis', array());

        return parent::getEmojis();
    }
    ...
    public function setEmojis($emojis)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmojis', array($emojis));

        return parent::setEmojis($emojis);
    }
